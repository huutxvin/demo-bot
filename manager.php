...
$bot_username = 'VinsCryptoBot'; // Without "@"
$bot_api_key  = '737975765:AAHA-GLIzwZBHNhZd_SgXr2f3DGU6F_9CgM';
try {
    $bot = new TelegramBot\TelegramBotManager\BotManager([
        ...
        'webhook'      => [
           ...
           'url' => 'https://cryptobot.yez.vn/manager.php',
           // Use self-signed certificate
           'certificate' => __DIR__ . '/fullchain.pem',
